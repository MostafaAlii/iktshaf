    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">اضافة نقاط / درجات جديد</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_profile_details" class="collapse show">
            <!-- Start Form -->
            <form action="{{ route('points.store') }}"  method="POST" id="create">
                @csrf
                <!--begin::Card body-->
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="type_name" class="form-control form-control-lg form-control-solid"  placeholder="ادخل اسم المستوى" value="{{old('type_name')}}"  />
                            @error('type_name')
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input class="form-control" type="number" name="min_point" />
                            @error("min_point")
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input class="form-control" type="number" name="max_point" />
                            @error("max_point")
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
