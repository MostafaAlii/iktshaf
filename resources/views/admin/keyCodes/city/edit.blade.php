    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0"> تعديل مدينة <span style="color: red"> {{$city->name}} </span></h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_profile_details" class="collapse show">
            <!-- Start Form -->
            <form method="POST" action="{{ route('updateCity') }}" id="create">
            @csrf
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="name" class="form-control form-control-lg form-control-solid"
                                   placeholder="ادخل إسم المدينة" value="{{$city->name}}" required/>
                            @error('name')
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="code" class="form-control form-control-lg form-control-solid"
                                   placeholder="ادخل كود المدينة" value="{{$city->code}}" minlength="2" maxlength="2"
                                   required/>
                            @error('code')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
