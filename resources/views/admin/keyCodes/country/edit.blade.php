    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">  تعديل دولة  <span style="color: red"> {{$country->name}} </span> </h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_profile_details" class="collapse show">
            <!-- Start Form -->
            <form action="{{ route('updateCountry', 'test') }}" method="POST" id="create">
            @csrf

                <input type="hidden" name="id" value="{{ $country->id }}" required/>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="name" class="form-control form-control-lg form-control-solid"
                                   placeholder="ادخل إسم الدولة" value="{{ $country->name }}" required/>
                        </div>
                    </div>
                    <!-- End Name -->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="code" class="form-control form-control-lg form-control-solid"
                                   placeholder="ادخل كود الدولة" value="{{ $country->code }}" minlength="2" maxlength="2" required/>
                        </div>
                    </div>
                    <!-- End code -->
