...
<script type="text/javascript">
    $(document).ready(function(){
        $('#jstree').jstree({
        "core" : {
            'data' :  {!! load_dep($article->department_id) !!},
            "themes" : {
            "variant" : "large"
            }
        },
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(assets/media/avatars/blank.png)">
                                ...
                                <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{Storage::url($article->photo)}})"></div>
                                @else  
              ...
              <div class="row mb-6">
                ...
                <!--begin::Col-->
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="title" class="form-control form-control-lg form-control-solid"  placeholder="العنوان" value="{{$article->title}}"  />
                        </div>        
                        <!--end::Col-->                                                  
            </div>
            <!--end::Input group-->
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="description" class="form-control form-control-lg form-control-solid" placeholder="الوصف" value="{{$article->description}}" />
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->   
                    ...
                    <hr>     
                     ...
                     <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <textarea id="elm1" class="form-control form-control-lg form-control-solid" name="content">{{ $article->content }}</textarea>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->                                                          
                    ...
                    <div class="row mb-6">
                        ...
                        <!--end::Label-->
                         <!--begin::Col-->
                         <div class="col-lg-8 fv-row">
                            <input type="text" name="tags" class="form-control form-control-lg form-control-solid" data-role="tagsinput" placeholder="التاج" value="{{$article->tags}}"  />
                        </div>        
                        <!--end::Col-->  
