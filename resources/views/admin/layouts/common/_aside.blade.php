...
<div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        ...
        <a href="{{url('admin/dashboard')}}">
            <img alt="Logo" src="{{ url('logo5@3x.png') }}" class="h-100px"/>
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
            ...
            <div
                ...
                <div class="menu-item">
                    <div class="menu-content pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ">المستخدمين</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="{{ aurl('admins') }}">
                        <span class="menu-icon">
                            <i class="bi bi-people fs-3"></i>
                        </span>
                        <span class="menu-title">الأدارة والمشرفين</span>
                    </a>
                </div>
                <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ aurl('codes') }}">
                        ...
                        <span class="menu-title">اكواد التاكيد</span>
                    </a>
                </div>
                <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{route('indexSchool')}}">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{route('indexCity')}}">
                        <span class="menu-icon">
                            <i class="bi bi-globe2 fs-3"></i>
                        </span>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{route('indexCountry')}}">
                        <span class="menu-icon">
                            <i class="bi bi-globe2 fs-3"></i>
                        </span>
                ...
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">المحتوى</span>
                    </div>
                </div>
                <div class="menu-item">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link"
                                       href="../../demo13/dist/authentication/email/password-reset.html" target="blank">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Password Reset</span>
