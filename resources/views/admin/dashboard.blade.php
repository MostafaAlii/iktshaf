            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">لوحة التحكم
                        ...
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class="text-muted fs-7 fw-bold my-1 ms-1">إلادارة</small>
                        <!--end::Description--></h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
                ...
                <div class="d-flex align-items-center py-1">
                    ...
                    <div class="menu-item me-lg-1">
                        <form method="POST" action="{{ route('logoutAdmin') }}">
                            @csrf
                            <a class="btn btn-sm btn-primary" onclick="event.preventDefault();
                        ...
                        <div class="card card-xl-stretch">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="card-p mt-n20 position-relative">
                                    ...
                                    <div class="row g-0">
                                        <!--begin::Col-->
                                        <div class="col-lg-2 bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            <!--end::Svg Icon-->
                                            <a href="{{route('admins')}}" class="text-warning fw-bold fs-6"> المديرين
                                                : {{count(\App\Models\Admin::all())}}</a>
                                        </div>
                                        <!--end::Col-->

                                        <!--begin::Col-->
                                        <div class="col-lg-2 bg-light-primary px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            <!--end::Svg Icon-->
                                            <a href="{{route('users')}}" class="text-primary fw-bold fs-6"> المشرفين
                                                : {{count(\App\Models\User::where('level', 2)->get())}}</a>
                                        </div>
                                        <!--end::Col-->

                                        <!--begin::Col-->
                                        <div class="col-lg-2 bg-light-success px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            <!--end::Svg Icon-->
                                            <a href="{{route('users')}}" class="text-success fw-bold fs-6 mt-2"> الاعضاء
                                                : {{count(\App\Models\User::where('level', 1)->get())}}</a>
                                        </div>
                                        <!--end::Col-->

                                        <!--begin::Col-->
                                        <div class="col-lg-2 bg-light-warning px-6 py-8 rounded-2 mb-7">
                                            <!--begin::Svg Icon | path: icons/duotune/general/gen032.svg-->
                                            <span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                         viewBox="0 0 24 24" fill="none">
                                            ...
                                            <!--end::Svg Icon-->
                                            <a href="{{route('department.index')}}" class="text-warning fw-bold fs-6">الأقسام
                                                : {{count(\App\Models\Department::all())}}</a>
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Row-->
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-lg-2 bg-light-primary px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            <!--end::Svg Icon-->
                                            <a href="{{route('article.index')}}" class="text-primary fw-bold fs-6">المقالات
                                                : {{count(\App\Models\Article::all())}}</a>
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-lg-2 bg-light-success px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            <!--end::Svg Icon-->
                                            <a href="{{route('tests.index')}}" class="text-success fw-bold fs-6 mt-2">الإختبارات
                                                : {{count(\App\Models\Test::all())}}</a>
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-lg-2 bg-light-primary px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            <!--end::Svg Icon-->
                                            <a href="{{route('collections.index')}}" class="text-primary fw-bold fs-6">المجموعات
                                                : {{count(\App\Models\Collection::all())}}</a>
                                        </div>
                                        <!--end::Col-->

                                        <!--begin::Col-->
                                        <div class="col-lg-2 bg-light-success px-6 py-8 rounded-2 mb-7">
                                            <!--begin::Svg Icon | path: icons/duotune/communication/com010.svg-->
                                            <span class="svg-icon svg-icon-3x svg-icon-success d-block my-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                         viewBox="0 0 24 24" fill="none">
                                            ...
                                            <a href="{{route('questions.index')}}"
                                               class="text-success fw-bold fs-6 mt-2">الأسئلة
                                                : {{count(\App\Models\Question::all())}}</a>
                                        </div>
                                        <!--end::Col-->
                ...
                <div class="row gy-5 g-xl-8">
                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-header border-0">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">أجدد المقالات</span>
                                    <span class="text-muted mt-1 fw-bold fs-7">Over {{count(\App\Models\Article::all())}} articles</span>
                                </h3>
                                <div class="card-toolbar">
                                    <!--begin::Menu-->
                                    <a href="{{route('article.index')}}"
                                       class="btn btn-sm btn-icon btn-color-primary btn-active-light-success">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen024.svg-->
                                        <span class="svg-icon svg-icon-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                                     viewBox="0 0 24 24">
                            ...
                            @php
                                $articles =\App\Models\Article::orderBy('id', 'desc')->limit(7)->get();
                            @endphp
                            ...
                            @foreach($articles as $article)
                                <!--begin::Item-->
                                    <div class="d-flex align-items-center mb-8">
                                        ...
                                        <!--end::Bullet-->
                                        <div class="symbol symbol-50px me-5  mx-5">
                                            <img src="assets/media/avatars/150-1.jpg" class="" alt=""/>
                                        </div>
                                        <!--begin::Description-->
                                        <div class="flex-grow-1">
                                            <a href="#" class="text-gray-800 text-hover-success fw-bolder fs-6">
                                                {{$article->title}}
                                            </a>
                                            <span class="text-muted fw-bold d-block">{{$article->created_at->diffForHumans()}}</span>
                                        </div>
                                        <!--end::Description-->
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-header border-0">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">أجدد المشرفين</span>
                                    <span class="text-muted mt-1 fw-bold fs-7">Over {{count(\App\Models\User::where('level', 2)->get())}} supervisors</span>
                                </h3>
                                <div class="card-toolbar">
                                    <!--begin::Menu-->
                                    <a href="{{route('users')}}"
                            ...
                            <div class="card-body pt-2">
                                ...
                                <div class="card-body pt-2">
                                @php
                                    $supervisors =\App\Models\User::where('level', 2)->orderBy('id', 'desc')->limit(7)->get();
                                @endphp
                                    ...
                                    <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-8">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <span class="text-muted fw-bold d-block">{{$supervisor->created_at->diffForHumans()}}</span>
                                            </div>
                                            <!--end::Description-->
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">أجدد الاعضاء</span>
                                    <span class="text-muted mt-1 fw-bold fs-7">Over {{count(\App\Models\User::where('level', 1)->get())}} members</span>
                                </h3>
                                <div class="card-toolbar">
                                    <!--begin::Menu-->
                                    <a href="{{route('users')}}"
                            ...
                            <div class="card-body pt-2">
                                ...
                                <div class="card-body pt-2">
                                @php
                                    $users =\App\Models\User::where('level', 1)->orderBy('id', 'desc')->limit(7)->get();
                                @endphp
                                ...
                                @foreach($users as $user)
                                    <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-8">
                                            ...
                                            <!--begin::Description-->
                                            <div class="flex-grow-1">
                                                <a href="#" class="text-gray-800 text-hover-danger fw-bolder fs-6">
                                                    {{$user->name}}
                                                </a>
                                                <span class="text-muted fw-bold d-block">{{$user->created_at->diffForHumans()}}</span>
                                            </div>
                                            <!--end::Description-->
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-xl-stretch">
                            ...
                            <div class="card-header align-items-center border-0 mt-4">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="fw-bolder mb-2 text-dark">اخر نشاط</span>
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <div>
                                                    <select class="form-select form-select-solid" data-kt-select2="true"
                                                            ...
                                                            data-dropdown-parent="#kt_menu_6155ae51c81bb"
                ...
                <div class="row gy-5 g-xl-8">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            <!--begin::Header-->
                            <div class="card-header border-0">
                                <h3 class="card-title fw-bolder text-dark">المقالات</h3>
                                <div class="card-toolbar">
                                    <!--begin::Menu-->
                                    <button type="button"
                                            class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary"
                ...
                <div class="row gy-5 g-xl-8">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            <!--begin::Header-->
                            <div class="card-header border-0">
                                <h3 class="card-title fw-bolder text-dark">المشرفين</h3>
                                <div class="card-toolbar">
                                    <!--begin::Menu-->
                                    <button type="button"
                                            class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary"
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            <!--begin::Header-->
                            <div class="card-header border-0">
                                <h3 class="card-title fw-bolder text-dark">الدفع</h3>
                                <div class="card-toolbar">
                                    <!--begin::Menu-->
                                    <button type="button"
                                            class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary"
