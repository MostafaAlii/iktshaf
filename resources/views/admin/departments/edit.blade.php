            ...
            @csrf
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        {!! Form::text('dep_name',$department->dep_name,['class'=>'control form-control-lg form-control-solid'])!!}
                        </div>   
                    </div>
                    <!-- End Code -->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            {!! Form::text('keyword',$department->keyword,['class'=>'form-control form-control-lg form-control-solid'])!!}
                            <!--begin::Hint-->
